...
class qtype_musictheory_interval_write extends qtype_musictheory_question implements qtype_musictheory_subtype {
	...
	public function get_question_text() {
		...
		$interval = get_string($this->musictheory_quality . $this->musictheory_size, 'qtype_musictheory');
...
class qtype_musictheory_interval_write_random extends qtype_musictheory_interval_write {
	...
	public function start_attempt(question_attempt_step $step, $variant) {
		...
		$randinterval =
				qtype_musictheory_randomiser::get_random_interval($this->musictheory_quality_random, $this->musictheory_size_random);
		$this->musictheory_size = $randinterval['size'];
		$this->musictheory_quality = $randinterval['quality'];
		$givennote =
				qtype_musictheory_randomiser::get_random_interval_givennote($this->musictheory_clef, $this->musictheory_direction);
