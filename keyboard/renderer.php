...
class qtype_musictheory_keyboard_input_renderer extends qtype_musictheory_renderer {
	...
	public function formulation_and_controls(question_attempt $qa,
		...
		$PAGE->requires->yui_module('moodle-qtype_musictheory-musictheorykeyboardui', 'M.qtype_musictheory.musictheorykeyboardui.init');
		...
		if ($question->musictheory_includestaticnote) {
			$staticnote = new Note($question->musictheory_staticnoteletter, $question->musictheory_staticnoteaccidental, $question->musictheory_staticnoteregister);
